...
Shader "ColorLerpLeaves"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		[ASEBegin]_Color1("Color 1", Color) = (1,1,1,0)
		_Color2("Color 2", Color) = (1,1,1,0)
		_Metallic("Metallic", Range( 0 , 1)) = 0
		_Smoothness("Smoothness", Range( 0 , 1)) = 0.5
		_ColorWeight("Color Weight", Range( 0 , 1)) = 0
		_Turbulence("Turbulence", Range( 0 , 100)) = 50
	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float2 temp_cast_1 = (_Turbulence).xx;
				float2 texCoord18 = v.texcoord.xy * temp_cast_1 + float2( 0,0 );
				float2 panner28 = ( _TimeParameters.x * temp_cast_0 + texCoord18);
				float simplePerlin3D16 = snoise( ( float3( panner28 ,  0.0 ) + v.vertex.xyz ) );
				float4 appendResult33 = (float4(( simplePerlin3D16 * _Axis.x ) , ( simplePerlin3D16 * _Axis.y ) , ( simplePerlin3D16 * _Axis.z ) , 0.0));
				...
				#endif
				float3 vertexValue = appendResult33.xyz;
				#ifdef ASE_ABSOLUTE_VERTEX_POS
						 ...
						 ) : SV_Target
			{
				...
				float4 lerpResult15 = lerp( _Color1 , _Color2 , _ColorWeight);
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v )
			{
				...
				float2 temp_cast_0 = (_Speed).xx;
				float2 temp_cast_1 = (_Turbulence).xx;
				float2 texCoord18 = v.ase_texcoord.xy * temp_cast_1 + float2( 0,0 );
				float2 panner28 = ( _TimeParameters.x * temp_cast_0 + texCoord18);
				float simplePerlin3D16 = snoise( ( float3( panner28 ,  0.0 ) + v.vertex.xyz ) );
				float4 appendResult33 = (float4(( simplePerlin3D16 * _Axis.x ) , ( simplePerlin3D16 * _Axis.y ) , ( simplePerlin3D16 * _Axis.z ) , 0.0));
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float2 temp_cast_0 = (_Speed).xx;
				float2 temp_cast_1 = (_Turbulence).xx;
				float2 texCoord18 = v.texcoord0.xy * temp_cast_1 + float2( 0,0 );
				float2 panner28 = ( _TimeParameters.x * temp_cast_0 + texCoord18);
				float simplePerlin3D16 = snoise( ( float3( panner28 ,  0.0 ) + v.vertex.xyz ) );
				float4 appendResult33 = (float4(( simplePerlin3D16 * _Axis.x ) , ( simplePerlin3D16 * _Axis.y ) , ( simplePerlin3D16 * _Axis.z ) , 0.0));
...
/*ASEBEGIN
Version=18935
6.4;5.6;1523.2;789.4;3376.589;326.4453;2.021791;True;False
Node;AmplifyShaderEditor.RangedFloatNode;19;-2817.692,365.6053;Inherit;False;Property;_Turbulence;Turbulence;5;0;Create;True;0;0;0;False;0;False;50;50;0;100;0;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;18;-2529.939,354.4102;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleTimeNode;30;-2485.695,629.3165;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;29;-2452.695,507.3163;Inherit;False;Property;_Speed;Speed;6;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.PosVertexDataNode;24;-1959.248,560.2587;Inherit;False;0;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.PannerNode;28;-2166.695,374.3163;Inherit;False;3;0;FLOAT2;0,0;False;2;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SimpleAddOpNode;26;-1731.742,471.7712;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.Vector3Node;34;-1507.796,612.9932;Inherit;False;Property;_Axis;Axis;7;0;Create;True;0;0;0;False;0;False;0,0,0;1,1,1;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.NoiseGeneratorNode;16;-1492.239,367.0103;Inherit;False;Simplex3D;False;False;2;0;FLOAT3;0,0,0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;35;-1246.796,480.9933;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;36;-1244.37,586.793;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;37;-1243.37,711.793;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;15;-346.7822,-428.423;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;13;-684.086,143.5029;Inherit;False;Property;_Smoothness;Smoothness;3;0;Create;True;0;0;0;False;0;False;0.5;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;14;-682.1821,-104.723;Inherit;False;Property;_ColorWeight;Color Weight;4;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;11;-613.281,-315.3225;Inherit;False;Property;_Color2;Color 2;1;0;Create;True;0;0;0;False;0;False;1,1,1,0;0.7813689,0.788,0.3155926,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;10;-615.8809,-555.8224;Inherit;False;Property;_Color1;Color 1;0;0;Create;True;0;0;0;False;0;False;1,1,1,0;0.4666665,0.9058824,0.4078431,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.DynamicAppendNode;33;-1066.796,370.9931;Inherit;False;FLOAT4;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.RangedFloatNode;12;-682.786,47.30301;Inherit;False;Property;_Metallic;Metallic;2;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;0,0;Float;False;True;-1;2;UnityEditor.ShaderGraphLitGUI;0;2;ColorLerpLeaves;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;19;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;2;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;True;1;1;False;-1;0;False;-1;1;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;False;False;False;True;1;LightMode=UniversalForward;False;False;0;Hidden/InternalErrorShader;0;0;Standard;40;Workflow;1;0;Surface;0;0;  Refraction Model;0;0;  Blend;0;0;Two Sided;1;0;Fragment Normal Space,InvertActionOnDeselection;0;0;Transmission;0;0;  Transmission Shadow;0.5,False,-1;0;Translucency;0;0;  Translucency Strength;1,False,-1;0;  Normal Distortion;0.5,False,-1;0;  Scattering;2,False,-1;0;  Direct;0.9,False,-1;0;  Ambient;0.1,False,-1;0;  Shadow;0.5,False,-1;0;Cast Shadows;1;0;  Use Shadow Threshold;0;0;Receive Shadows;1;0;GPU Instancing;1;0;LOD CrossFade;1;0;Built-in Fog;1;0;_FinalColorxAlpha;0;0;Meta Pass;1;0;Override Baked GI;0;0;Extra Pre Pass;0;0;DOTS Instancing;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,-1;0;  Type;0;0;  Tess;16,False,-1;0;  Min;10,False,-1;0;  Max;25,False,-1;0;  Edge Length;16,False,-1;0;  Max Displacement;25,False,-1;0;Write Depth;0;0;  Early Z;0;0;Vertex Position,InvertActionOnDeselection;1;638111891154263600;Debug Display;0;0;Clear Coat;0;0;0;10;False;True;True;True;True;True;True;True;True;True;False;;False;0
...
ASEEND*/
//CHKSM=AFBF73B3FE1D1DE9CF8BEAB3267D19BC2E6ED606